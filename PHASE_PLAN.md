...
- **Remaining — ⬜ TODO:** contract shares (fixed/variable, multiple backers per plan), delayed-settlement holds (milestone/scheduled escrow release), a PING calendar view.
